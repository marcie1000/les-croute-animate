...
extern bool CheckCharacterOnTheGround(int nb_objs, interobj *objs, character *ch, int *main_tiles_grid, 
...
//extern void objCollisionSpecialActions(int id_obj, interobj **objs, character *ch, int **main_tiles_grid, int nb_tiles_x);
